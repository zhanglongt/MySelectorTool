...
public class LoopView extends View {
    ...
    private void initLoopView(Context context) {
        ...
        colorGrayLightss = 0x00000000; //0xffc5c5c5;
        l = 2.0F;
        isLoop = true;
        positon = -1;
        r = 9;
    ...
    private void d() {
        ...
        //两侧线
        paintC = new Paint();
        paintC.setColor(colorGrayLightss);
...
//        return mDataList.get(mCurrentItem).entrySet().iterator().next().getKey();
//    }
//
//    public String getText_value(){//获取值
//        return mDataList.get(mCurrentItem).entrySet().iterator().next().getValue();
//    }
